...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.getPokemon = function (id) {
        ...
        return this.http.get(url).pipe(operators_1.tap(function (_) { return _this.log("fetched pokemon id=" + id); }), operators_1.catchError(this.handleError("get pokemon id=" + id)));
    };
